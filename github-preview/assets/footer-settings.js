(() => {
  ...
  const defaultMenuItems = [
    ...
    { id: "about", labelDe: "Über mich", labelEn: "About", visible: true, order: 2 },
    { id: "film", labelDe: "Film", labelEn: "Film", visible: true, order: 3 },
    { id: "portfolio", labelDe: "Portfolio", labelEn: "Portfolio", visible: true, order: 4 },
    { id: "journal", labelDe: "Journal", labelEn: "Journal", visible: true, order: 5 },
    { id: "contact", labelDe: "Kontakt", labelEn: "Contact", visible: true, order: 6 },
    { id: "academy", labelDe: "Academy", labelEn: "Academy", visible: true, order: 7 }
  ];
  ...
  const renderInstagramFeed = (settings, lang, posts, fallbackImages = []) => {
    ...
    const cards = realCards.length ? realCards : fallbackImages
      .slice(0, 3)
      .map((image, index) => ({
        url: accountUrl,
        image,
    ...
    feedNode.innerHTML = `
      <div class="footer-instagram-inner">
        <a href="${accountUrl}" target="_blank" rel="noreferrer" class="footer-instagram-title">Instagram</a>
        <div class="footer-instagram-grid">
          ${cards.map((post, index) => {
            const fallback = String(fallbackImages[index % Math.max(1, fallbackImages.length)] || "").replace(/"/g, "&quot;");
            return `
